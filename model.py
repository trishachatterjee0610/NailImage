...
def vgg16_cnn_model():
    ...
    vgg_model.add(Dense(units=2, activation='softmax',kernel_initializer='he_uniform'))
...
def training_baseline_model():
    ...
    save_model_to = f'{CURRENT_DIRECTORY}/model/baseline-cnn-model.hdf5'
    ...
    checkpoint = ModelCheckpoint(save_model_to, monitor='val_acc',verbose=0,save_weights_only=False,save_best_only=True, mode='auto',period=1)
...
def training_vgg16_model():
    ...
    save_model_to = f'{CURRENT_DIRECTORY}/model/vgg16-classifier-model.hdf5'
